...
export const projectsData: Project[] = [
  {
    title: "Emojify",
    description:
      "Built an emotion-based activity suggestion app that promotes user well-being. Integrated face detection and emotion recognition.",
  ...
  },
  {
    title: "Neura",
    description:
      "Modern AI chatbot mobile app with natural language conversations. Clean and responsive UI with React Native.",
  ...
  },
  {
    title: "Crime Record",
    description:
      "Desktop application for managing criminal records with Java Swing GUI and MySQL database.",
  ...
  },
  {
    title: "Car Claim",
    description:
      "Fraud detection model for car insurance claims using machine learning and data analysis.",
  ...
  },
  {
    title: "Spam Filter",
    description:
      "Machine learning model using Naive Bayes algorithm for spam email detection with NLP techniques.",
    tech: ["Flask", "Python", "Scikit-learn"],
    icon: <BabyIcon className="w-6 h-6 text-orange-600" />,
    url: "https://github.com/iamhimanshu98/SpamFilter",
  },
  {
    title: "News Credibility",
    description:
      "A machine learning app that uses Natural Language Processing & Logistic Regression to classify news articles.",
    tech: ["Django", "NLP", "Scikit-learn"],
    icon: <BrainCircuit className="w-6 h-6 text-orange-600" />,
    url: "https://github.com/iamhimanshu98/Fake-News-Detection",
  },
];
